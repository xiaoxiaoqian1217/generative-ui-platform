...
UI Compiler Core 现已实现 summary、form 和 confirmation 场景的确定性编译链路，包括输入和 Catalog 校验、领域组件选择、Props 与 Action 权威校验、UI IR lowering、A2UI 0.9.1 Profile 编译和 Markdown 降级。
