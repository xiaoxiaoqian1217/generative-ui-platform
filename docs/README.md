...
在 #207 完成前，仓库的可执行链路仍以现有 AGUIMock + CopilotKit Frontend 为准。

CopilotKit Runtime 是 ADR-0029 已接受的**当前实现目标**，不是在文档提交时已经完成的代码事实。

同样，A2UI Renderer / Catalog / Theme 是下一阶段路线，不应在实现前被描述为已完成能力。
